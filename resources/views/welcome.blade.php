            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <header class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
                    <div class="flex lg:justify-center lg:col-start-2">
                        ...
                        >
                            <!-- Chemin du logo (personnalisable) -->
                            <path
                                d="M61.8548 14.6253C61.8778 14.7102 61.8895 14.7978 61.8897 14.8858V28.5615C..."
                                fill="currentColor"
                            ></path>
                        </svg>
                    </div>

                    <!-- Barre de navigation (Log in / Register) -->
                ...
                <main class="mt-6">
                        ...
                        <div class="relative flex items-center gap-6 lg:items-end">
                            <div class="pt-3 sm:pt-5 lg:pt-0">
                                ...
                                <p class="mt-4 text-sm/relaxed text-gray-600 dark:text-gray-300">
                                    Simplifiez la collaboration et la gestion de vos projets
                                    grâce à notre plateforme. Créez des tâches, invitez des
                                    membres, suivez l'avancement, et optimisez votre workflow
                                    au quotidien. Profitez d’une interface moderne et
                                    personnalisable pour travailler en équipe de manière
                                    efficace.
                                </p>
                            </div>
                        </div>
                    ...
                    <div class="grid gap-6 lg:grid-cols-2 lg:gap-8 mt-6">
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed text-gray-600 dark:text-gray-300">
                                    Invitez facilement vos coéquipiers, attribuez des rôles
                                    (admin ou membre), et collaborez en temps réel pour
                                    accomplir vos objectifs plus rapidement.
                                </p>
                            </div>
                        </a>
                        ...
                        >
                            ...
                            <div class="pt-3 sm:pt-5">
                                ...
                                <p class="mt-4 text-sm/relaxed text-gray-600 dark:text-gray-300">
                                    Gérez vos tâches, assignez-les aux membres, suivez
                                    l'avancement et profitez de nombreuses fonctionnalités
                                    (notifications, filtres, uploads de fichiers) pour
                                    garder le contrôle.
                                </p>
                            </div>
                        </a>
                    ...
                    <!-- Autres contenus/avantages si nécessaire -->
                    <div class="mt-6 flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] lg:pb-10 dark:bg-zinc-900 dark:ring-zinc-800 dark:hover:text-white/70 dark:hover:ring-zinc-700 dark:focus-visible:ring-[#FF2D20]">
                        <div class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16">
                            ...
                            >
                                <g fill="#FF2D20">
                                    <!-- Icône personnalisable -->
                                    <path d="M16.597 12.635a.247.247 0 0 0-.08-.237 2.234 2.234 0 0 1-.769-1.68c.001-.195.03-.39.084-.578..."></path>
                                </g>
                            </svg>
                        </div>
                        ...
                        <div class="pt-3 sm:pt-5">
                            ...
                            <p class="mt-4 text-sm/relaxed text-gray-600 dark:text-gray-300">
                                Personnalisez l’apparence et les workflows pour
                                correspondre à votre équipe. Notre solution s’adapte
                                à vos besoins, qu’il s’agisse de projets simples ou
                                de gestion avancée.
                            </p>
                        </div>
                    </div>
                ...
                <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                    Gestionnaire de Projets v1.0 • PHP v8.3.16
                </footer>
            </div>
        </div>
    </div>
